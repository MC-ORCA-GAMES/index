/* MC ORCA GAMES — Service Worker fuer Aetheris — Echoes of an Eternal Empire
...
self.addEventListener("fetch", (e) => {
  ...
  e.respondWith(
    fetch(e.request)
      ...
      .catch(() => caches.match(e.request).then((r) => r || caches.match("./game.html")))
  );
});
